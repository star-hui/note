...
- [1. 简单介绍](#1-简单介绍)
    - [1.1. git起源](#11-git起源)
    - [1.2. 集中式vs分布式](#12-集中式vs分布式)
    - [1.3. 各种git的介绍](#13-各种git的介绍)
    - [1.4. git的安装](#14-git的安装)
- [2. 本地git的使用](#2-本地git的使用)
    - [2.1. 初始化本地仓库](#21-初始化本地仓库)
    - [2.2. 配置识别账户与密码](#22-配置识别账户与密码)
    - [2.3. git的操作](#23-git的操作)
    - [2.4. 三区:工作区、缓存区、版本区](#24-三区工作区缓存区版本区)
    - [2.5. 查看提交的版本信息](#25-查看提交的版本信息)
    - [2.6. 版本回退-git reset](#26-版本回退-git-reset)
    - [2.7. 撤销-git checkout](#27-撤销-git-checkout)
- [3. 远端仓库](#3-远端仓库)
    - [3.1. github设置](#31-github设置)
    - [3.2. 两种连接方式](#32-两种连接方式)
    - [3.3. 克隆云端的项目](#33-克隆云端的项目)
    - [3.4. 分支管理](#34-分支管理)
